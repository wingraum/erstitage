...
var classNames = {"time_table_wrapper":"styles-module_time_table_wrapper__TT-cf","day":"styles-module_day__aQ2Tt","day_title":"styles-module_day_title__cc17c","hour":"styles-module_hour__TLyj9","event":"styles-module_event__28gBZ","event_info":"styles-module_event_info__WLqqh"};
...
var getRowHeight = function (from, to, totalHeight) {
    var numberOfRows = to - from + 1;
    return round_1(totalHeight / numberOfRows, 5);
};
...
var DayHeaderPreview = function (_a) {
    var day = _a.day, rowHeight = _a.rowHeight, otherProperties = __rest(_a, ["day", "rowHeight"]);
    return (jsxRuntime.jsx("div", __assign({}, otherProperties, { style: __assign(__assign({}, ((otherProperties === null || otherProperties === void 0 ? void 0 : otherProperties.style) || {})), { height: "".concat(rowHeight, "px") }) }, { children: getDefaultDayLabel(day) })));
};
var HourPreview = function (_a) {
    var hour = _a.hour, otherProperties = __rest(_a, ["hour"]);
    return (React.createElement("div", __assign({}, otherProperties, { key: hour }), hour));
};
var EventPreview = function (_a) {
    var event = _a.event, defaultAttributes = _a.defaultAttributes, classNames = _a.classNames;
    return (React.createElement("div", __assign({}, defaultAttributes, { title: event.name, key: event.id }),
        jsxRuntime.jsx("span", __assign({ className: classNames.event_info }, { children: event.name })),
        jsxRuntime.jsxs("span", __assign({ className: classNames.event_info }, { children: [format(event.startTime, "HH:mm"), " - ", format(event.endTime, "HH:mm")] }))));
};
var EventsList = function (_a) {
    ...
    return (events[day] || []).map(function (event) {
        return renderEvent({
            event: event,
            defaultAttributes: {
                className: "".concat(classNames.event, " ").concat(classNames.type),
...
var DayColumnPreview = function (_a) {
    var events = _a.events, day = _a.day, index = _a.index, rowHeight = _a.rowHeight, renderDayHeader = _a.renderDayHeader, renderEvent = _a.renderEvent, hoursInterval = _a.hoursInterval, headerAttributes = _a.headerAttributes, bodyAttributes = _a.bodyAttributes;
    return (React.createElement("div", __assign({}, bodyAttributes, { className: "".concat(classNames.day, " ").concat(day, " ").concat((bodyAttributes === null || bodyAttributes === void 0 ? void 0 : bodyAttributes.className) || ""), style: __assign(__assign({}, ((bodyAttributes === null || bodyAttributes === void 0 ? void 0 : bodyAttributes.style) || {})), { backgroundSize: "1px ".concat(2 * rowHeight, "px"), width: "calc((100% - 5rem) / ".concat(Object.keys(events).length, ")") }), key: "".concat(day, "-").concat(index) }),
        renderDayHeader(__assign(__assign({ day: day, rowHeight: rowHeight }, headerAttributes), { className: "".concat(classNames.day_title, " ").concat((headerAttributes === null || headerAttributes === void 0 ? void 0 : headerAttributes.className) || "") })),
        EventsList({
            events: events,
            day: day,
...
var HoursList = function (_a) {
    ...
    return range_1(hoursInterval.from, hoursInterval.to).map(function (hour) {
        return renderHour({
            ...
            style: { height: "".concat(rowHeight, "px") },
        });
    });
};
var TimeTable = function (_a) {
    var events = _a.events, _b = _a.hoursInterval, hoursInterval = _b === void 0 ? DEFAULT_HOURS_INTERVAL : _b, _c = _a.timeLabel, timeLabel = _c === void 0 ? "Time" : _c, _d = _a.renderDayHeader, renderDayHeader = _d === void 0 ? DayHeaderPreview : _d, _e = _a.renderEvent, renderEvent = _e === void 0 ? EventPreview : _e, _f = _a.renderHour, renderHour = _f === void 0 ? HourPreview : _f, headerAttributes = _a.headerAttributes, bodyAttributes = _a.bodyAttributes, otherProperties = __rest(_a, ["events", "hoursInterval", "timeLabel", "renderDayHeader", "renderEvent", "renderHour", "headerAttributes", "bodyAttributes"]);
    var _g = React__namespace.useState({
        width: window.innerWidth,
        height: window.innerHeight,
    }), dimensions = _g[0], setDimensions = _g[1];
    var _h = React__namespace.useState(0), rowHeight = _h[0], setRowHeight = _h[1];
    ...
    React__namespace.useEffect(function () {
        if (ref.current) {
            var totalHeight = ref.current.clientHeight;
            setRowHeight(getRowHeight(hoursInterval.from, hoursInterval.to, totalHeight));
        }
    }, [hoursInterval, dimensions]);
    return (jsxRuntime.jsxs("div", __assign({}, otherProperties, { className: "".concat(classNames.time_table_wrapper, " ").concat(otherProperties.className), ref: ref }, { children: [jsxRuntime.jsxs("div", __assign({ className: classNames.day }, { children: [jsxRuntime.jsx("div", __assign({}, headerAttributes, { className: "".concat(classNames.day_title, " ").concat((headerAttributes === null || headerAttributes === void 0 ? void 0 : headerAttributes.className) || ""), style: __assign(__assign({}, ((headerAttributes === null || headerAttributes === void 0 ? void 0 : headerAttributes.style) || {})), { height: "".concat(rowHeight, "px") }) }, { children: timeLabel })), HoursList({ hoursInterval: hoursInterval, renderHour: renderHour, rowHeight: rowHeight })] })), Object.keys(events).map(function (day, index) {
...
TimeTable.propTypes = {
    ...
    renderDayHeader: PropTypes__default["default"].func,
    ...
    headerAttributes: PropTypes__default["default"].object,
    bodyAttributes: PropTypes__default["default"].object,
};
...
exports.DayHeaderPreview = DayHeaderPreview;
exports.EventPreview = EventPreview;
exports.EventsList = EventsList;
exports.HourPreview = HourPreview;
