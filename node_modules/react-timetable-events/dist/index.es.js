...
var DayHeaderPreview = function (_a) {
    ...
    return (jsx("div", __assign({}, otherProperties, { style: __assign(__assign({}, ((otherProperties === null || otherProperties === void 0 ? void 0 : otherProperties.style) || {})), { height: "".concat(rowHeight, "px") }) }, { children: getDefaultDayLabel(day) })));
};
var HourPreview = function (_a) {
    var hour = _a.hour, otherProperties = __rest(_a, ["hour"]);
    return (createElement("div", __assign({}, otherProperties, { key: hour }), hour));
};
var EventPreview = function (_a) {
    ...
    return (createElement("div", __assign({}, defaultAttributes, { title: event.name, key: event.id }),
        jsx("span", __assign({ className: classNames.event_info }, { children: event.name })),
        jsxs("span", __assign({ className: classNames.event_info }, { children: [format(event.startTime, "HH:mm"), " - ", format(event.endTime, "HH:mm")] }))));
};
...
var TimeTable = function (_a) {
    ...
    return (jsxs("div", __assign({}, otherProperties, { className: "".concat(classNames.time_table_wrapper, " ").concat(otherProperties.className), ref: ref }, { children: [jsxs("div", __assign({ className: classNames.day }, { children: [jsx("div", __assign({}, headerAttributes, { className: "".concat(classNames.day_title, " ").concat((headerAttributes === null || headerAttributes === void 0 ? void 0 : headerAttributes.className) || ""), style: __assign(__assign({}, ((headerAttributes === null || headerAttributes === void 0 ? void 0 : headerAttributes.style) || {})), { height: "".concat(rowHeight, "px") }) }, { children: timeLabel })), HoursList({ hoursInterval: hoursInterval, renderHour: renderHour, rowHeight: rowHeight })] })), Object.keys(events).map(function (day, index) {
...
export { DayHeaderPreview, EventPreview, EventsList, HourPreview, HoursList, TimeTable, TimeTable as default };
