    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid} >
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 10 && theactualtime < 11 ? "#0070f3" : "none" }}>
            <h2>Inoffizielle Begrüßung</h2>
            <p style={{fontWeight:"bold", marginTop:"10px"}}>10-11 Uhr</p>
          </a>
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 11 && theactualtime < 12 ? "#0070f3" : "none" }}>
            <h2>Offizielle Begrüßung</h2>
            <p style={{fontWeight:"bold", marginTop:"10px"}}>11-12:30 Uhr</p>
          </a>
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 12 && theactualtime < 13 ? "#0070f3" : "none" }}>
            <h2>Gruppenfoto</h2>
            <p style={{fontWeight:"bold", marginTop:"10px"}}>12:30-13 Uhr</p>
          </a>
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 13 && theactualtime < 14 ? "#0070f3" : "none" }}>
            <h2>Mittagspause</h2>
            <p style={{fontWeight:"bold", marginTop:"10px"}}>13-14 Uhr</p>
          </a>
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 14 && theactualtime < 15 ? "#0070f3" : "none" }}>
            <h2>Vorstellung des VWI</h2>
            <p style={{fontWeight:"bold", marginTop:"10px"}}>14-14:30 Uhr</p>
          </a>
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 15 && theactualtime < 18 ? "#0070f3" : "none" }}>
            <h2>Campusrallye</h2>
            <p style={{fontWeight:"bold", marginTop:"10px"}}>14:30-18 Uhr</p>
          </a>
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 18 && theactualtime < 20 ? "#0070f3" : "none" }}>
            <h2>Freizeit</h2>
            <p style={{fontWeight:"bold", marginTop:"10px"}}>18-20 Uhr</p>
          </a>
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 20 && theactualtime < 24 ? "#0070f3" : "none" }}>
            <h2>Abendprogramm</h2>
        ...
        <div className={styles.grid} >
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 9 && theactualtime < 10 ? "#0070f3" : "none" }}>
          ...
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 13 && theactualtime < 15 ? "#0070f3" : "none" }}>
        ...
        <div className={styles.grid} >
          <a className={styles.card} style={{width:"100%", backgroundColor: theactualtime >= 10 && theactualtime < 12 ? "#0070f3" : "none" }}>
